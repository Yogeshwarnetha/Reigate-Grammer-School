...
import AdventureSportsbannerImage from '@/public/images/kids writing 1.png'
import './index.css'
import AdventureSportsBottomImage from '@/public/images/kid with dog 1.png'

import SportImage1 from '@/public/Service and Community/Group 152.png'
import SportImage2 from '@/public/Service and Community/Group 153.png'

import SportImage3 from '@/public/Service and Community/Group 154.png'

import SportImage4 from '@/public/Service and Community/Group 155.png'

import SportImage5 from '@/public/Service and Community/Group 156.png'

import SportImage6 from '@/public/Service and Community/Group 157.png'
import BannerImage from '@/public/images/Banner image.png'


const ServiceandCommunity = () => {
  return (
    <>
    <section className="w-full">
              ...
              <div className="navbar-banner">
                ...
                Instilling a lifelong spirit of giving.                </h2>
              </div>
            </section>
    ...
    <section className='activity-section-1-background-container'>
      <div className='container mx-auto activity-section-1-main-container'>
        <div className='activity-section-1-text-container'>
          ...
          We are committed to fostering a culture of service and community engagement among our students. Through these programmes, students are encouraged to contribute positively to society, enhancing their personal growth and understanding of the world around them.            </p>
        </div>
  ...
  <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-x-6 gap-y-6 w-[75%]">
    ...
    <div className="col-span-full flex justify-center gap-x-8">
      <Image src={SportImage5} alt="SportImage" className="w-[250px] h-auto" />
      <Image src={SportImage6} alt="SportImage" className="w-[250px] h-auto" />
    </div>
  </div>
</div>
    </section>
    ...
    <div className='activity-section-1-image-container'>
        ...
        <div className='activity-section-1-text-container'>
          ...
          <p className='activity-section-1-description'>We recognise students’ dedication to service and community, celebrating their compassion, leadership, and commitment to making a meaningful impact.</p>
        </div>
...
export default ServiceandCommunity
